...
void create_thermal_card_ui(lv_obj_t* parent_dashboard) {
    ...
    lv_obj_add_style(card_thermal_fan_switch, &style_switch_on_cyan, static_cast<lv_style_selector_t>(LV_PART_INDICATOR) | static_cast<lv_style_selector_t>(LV_STATE_CHECKED));
    ...
    lv_obj_add_style(card_thermal_heater_switch, &style_switch_on_cyan, static_cast<lv_style_selector_t>(LV_PART_INDICATOR) | static_cast<lv_style_selector_t>(LV_STATE_CHECKED));
